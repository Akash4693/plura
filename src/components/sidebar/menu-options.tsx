...
import { SubAccountSidebarOption } from "@/lib/types/sub-account-sidebar-option.types";
                ...
                {(user?.role === Role.AGENCY_OWNER ||
                  ...
                  <SheetClose>
                    <Button
                      ...
                      onClick={() => {
                        console.log('Opening modal with agencyDetails:', user?.Agency);
                        setOpen(
                          <CustomModal
